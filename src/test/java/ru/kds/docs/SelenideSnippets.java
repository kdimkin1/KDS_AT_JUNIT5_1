...
public class SelenideSnippets {
    ...
    void browser_command_examples() {
        ...
        open("/", AuthenticationType.BASIC, "user", "password"); // example for selenide before 6.3.2
        open("/", AuthenticationType.BASIC,
              new BasicAuthCredentials("user", "password"));  // example for selenide 6.3.2
