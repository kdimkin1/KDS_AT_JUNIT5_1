...
public class AutomationPracticeFormFillTestsWithPOAndRandomVars extends TestBase {
    ...
    //Test data variables
    String firstName = RandomUtils.getRandomString(10),//"Anton",
           lastName = RandomUtils.getRandomString(10),//"Gorodetskiy",
           userEmail = RandomUtils.getRandomEmail(),//"Anton.Gorodetskiy@mail.com",
            gender = "Male",
            userNumber = String.valueOf(RandomUtils.getRandomInt(1000000000, 1999999999)),//"9296112233",
            ...
            currentAddress = RandomUtils.getRandomString(10),//"Karnal Bus Stand",
            state = "Haryana",
            city = "Karnal";
