...
public class WebSteps {
    ...
    @Step("Проверяем,  что Issue c номером 2 имеет название: {num}")
    public void shouldSeeIssue2WithName(String issueName) {
        $("#issue_2_link").shouldHave(Condition.text(issueName));
    }
